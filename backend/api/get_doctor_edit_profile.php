<?php
/**
 * Get Doctor Edit Profile API
 * GET: get_doctor_edit_profile.php?doctor_id=1
...
$initials = "";
$displayName = $doctor['display_name'] ?: $doctor['full_name'];
...
/* ---------- RETURN DATA ---------- */
sendResponse(true, "Edit profile data retrieved successfully", [
    'doctor_id' => $doctor['doctor_id'],
    'full_name' => $doctor['full_name'] ?? '',
    'email' => $doctor['email'] ?? '',
    'mobile' => $doctor['mobile'] ?? '',
    'license_no' => $doctor['license_no'] ?? '',
    'display_name' => $doctor['display_name'] ?: $doctor['full_name'],
